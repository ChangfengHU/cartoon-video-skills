...
export function serverFor(library) {
  const server = new McpServer({name:'vyibc-cartoon-assets', version:'1.0.0'});
...
export default {
  async fetch(request, env, ctx) {
    try {
      ...
      if (url.pathname === '/health' && request.method === 'GET') return Response.json({service:'vyibc-cartoon-assets',version:'1.0.0',authentication:'required',tools:8});
